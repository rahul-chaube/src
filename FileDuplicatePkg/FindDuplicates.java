...
public class FindDuplicates {
    ...
    public FindDuplicates(String path) {
        checkFile(path);
    }
    ...
    public  void findDuplicateFiles(Map<String, List<String>> filesList, File directory) {
        for (File dirChild : directory.listFiles()) {
            ...
            if (dirChild.isDirectory()) {
                ...
                try {
                    ...
                    fileInput.close();
                    System.out.println(" Checking......"+dirChild.toString()+" File Size is "+dirChild.length());
...
//        }
        ...
        {
            System.out.println("File Directory is correct");
        }
        ...
        for (List<String> list : lists.values()) {
            if (list.size() > 1) {
                ...
                for (String file : list) {
                    System.out.println("Duplicate File is "+ file);
                }
            }
        }
        System.out.println("\n");
